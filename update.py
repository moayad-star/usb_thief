...
try:
    try:
        test_connect = str(requests.get("http://www.github.com/moayad-star/usb_thief"))
    ...
    system("apt upgrade -y ; cd .. ; rm -rif usb_thief ; git clone https://github.com/moayad-star/usb_thief.git")
